...
?>
                            ...
                            <?php for ($i = 1; $i <= 7; $i++):?>
                                ...
                                <span>
                                    ...
                                    <?php if (($week[$i]['ovulationDay'] == 0)&&($week[$i]['menstruationDay']==0)&&($week[$i]['conceptionNegativeDay']==1)):?>
                                        <div class="col-xs-12 calendar-one-day conception-safe-day" data-title="<?=Yii::t('app','Conditionally safe days')?>">
                                <span>
                                    <?=$week[$i]['dayInMonth'];?>
                                </span>
                                        </div>
    ...
    <div class="legend-center">
        ...
        <div class="calendar-legend">
            <div class="calendar-legend-image conception-safe-day-legend">

            </div>
            <div class="calendar-legend-text">
                <?=Yii::t('app','Conditionally safe days')?>
            </div>
        </div>

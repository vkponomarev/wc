...
?>
    ...
    <div class="<?php if (($pregnancyCalculationByFetalMovement['pregnancyCalculationDivShow']) or Yii::$app->params['embed']):?>result-div-on<?php else: ?>result-div-off<?php endif ?>">

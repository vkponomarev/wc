            ...
            <div>
                <label class="form-left-label" id="form-label-id-one">
                            <span class="form-radio">
                                <?php if ($result['calculation']['pregnancyCalculationMethod'] == 1): ?>
                                    <input type="radio" name="method" value="1" checked="checked" class="">
                                <?php elseif (!$result['calculation']['pregnancyCalculationMethod']): ?>
                                    <input type="radio" name="method" value="1" checked="checked" class="">
                                <?php else: ?>
                ...
                <label class="form-left-label" id="form-label-id-two">
                            <span class="form-radio">
                                ...
                                <?php if ($result['calculation']['pregnancyCalculationMethod'] == 2): ?>
...
<div class="<?php if (($result['calculation']['pregnancyCalculationDivShow']) or Yii::$app->params['embed']): ?>result-div-on<?php else: ?>result-div-off<?php endif ?>">
    ...
    <div class="result-div-text">
        ...
        <span class="result-main-text">
                    ...
                    <?php if ($result['calculation']['pregnancyCalculationExceptionMonth'] == 'echoPlanning'): ?>

                        <?= Yii::t('app', 'You are planning a pregnancy') ?>

                    <?php endif ?>

                    <?php if ($result['calculation']['pregnancyCalculationExceptionMonth'] == 'echoHaveBaby'): ?>

                        <?= Yii::t('app', 'You have already given birth to a baby') ?>

                    <?php endif ?>

                    <?php if ($result['calculation']['pregnancyCalculationExceptionMonth'] == 'echoMonths'): ?>

                        <?= Yii::t('app', '{n,plural, one{# month} few{# months} other{# months}}', ['n' => $result['calculation']['pregnancyMonths']]) ?>
...
<div class="calendar-center">
    ...
    //echo $countMonths . '<br>';
    $countMonths = $result['calendar']['startMonth'];
    //echo  $pregnancyCalendar['startMonth'];
    foreach ($result['calendar']['calendar'] as $months) :?>
        ...
        <div class="calendar-one-month">
            <div class="col-xs-12 calendar-month-name">
                ...
                <span>
                    ...
                    <?= $result['nameOfMonthsInYear'][$countMonthsForName]; ?>
                            ...
                            <?php if (isset($week[$i])): ?>
                                ...
                                <?php if (($week[$i]['monthOfPregnancy1'] == 1)
                                    ...
                                    <div class="col-xs-12 calendar-one-day pregnancy-day-odd"
                                         data-title="1 <?= Yii::t('app', 'month of pregnancy') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                ...
                                <?php elseif (($week[$i]['monthOfPregnancy2'] == 1)
                                    ...
                                    <div class="col-xs-12 calendar-one-day pregnancy-day-even"
                                         data-title="2 <?= Yii::t('app', 'month of pregnancy') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>
                                <?php elseif (($week[$i]['monthOfPregnancy3'] == 1)
                                    ...
                                    <div class="col-xs-12 calendar-one-day pregnancy-day-odd"
                                         data-title="3 <?= Yii::t('app', 'month of pregnancy') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>
                                <?php elseif (($week[$i]['monthOfPregnancy4'] == 1)
                                    ...
                                    <div class="col-xs-12 calendar-one-day pregnancy-day-even"
                                         data-title="4 <?= Yii::t('app', 'month of pregnancy') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>
                                <?php elseif (($week[$i]['monthOfPregnancy5'] == 1)
                                    ...
                                    <div class="col-xs-12 calendar-one-day pregnancy-day-odd"
                                         data-title="5 <?= Yii::t('app', 'month of pregnancy') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>
                                <?php elseif (($week[$i]['monthOfPregnancy6'] == 1)
                                    ...
                                    <div class="col-xs-12 calendar-one-day pregnancy-day-even"
                                         data-title="6 <?= Yii::t('app', 'month of pregnancy') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>
                                <?php elseif (($week[$i]['monthOfPregnancy7'] == 1)
                                    ...
                                    <div class="col-xs-12 calendar-one-day pregnancy-day-odd"
                                         data-title="7 <?= Yii::t('app', 'month of pregnancy') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>
                                <?php elseif (($week[$i]['monthOfPregnancy8'] == 1)
                                    ...
                                    <div class="col-xs-12 calendar-one-day pregnancy-day-even"
                                         data-title="8 <?= Yii::t('app', 'month of pregnancy') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>
                                <?php elseif (($week[$i]['monthOfPregnancy9'] == 1)
                                    ...
                                    <div class="col-xs-12 calendar-one-day pregnancy-day-odd"
                                         data-title="9 <?= Yii::t('app', 'month of pregnancy') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>
                                <?php elseif (($week[$i]['todayDate'] == 1)
                                    ...
                                    <div class="col-xs-12 calendar-one-day pregnancy-today-day"
                                         data-title="<?= Yii::t('app', 'Present day') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>
                                <?php elseif ($week[$i]['trimesterTwo'] == 1): ?>
                                    <div class="col-xs-12 calendar-one-day pregnancy-trimester-two-day"
                                         data-title="<?= Yii::t('app', 'Start of the second trimester') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>
                                <?php elseif ($week[$i]['trimesterThree'] == 1): ?>
                                    <div class="col-xs-12 calendar-one-day pregnancy-trimester-three-day"
                                         data-title="<?= Yii::t('app', 'Start of the third trimester') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>
                                <?php elseif ($week[$i]['dueDate'] == 1): ?>
                                    <div class="col-xs-12 calendar-one-day pregnancy-due-date"
                                         data-title="<?= Yii::t('app', 'Estimated due date') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>
                                </span>
                                    </div>

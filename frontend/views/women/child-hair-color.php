    ...
    <form action="./<?php if (!Yii::$app->params['embed']): ?>#result<?php endif; ?>">
        ...
        <div class="form-content">
            ...
            <div class="col-xs-12 col-sm-6 align-mid">
                ...
                <div class="form-left-title"><?= Yii::t('app', 'Mom\'s hair color:') ?></div>
                ...
                <div class="form-left-title"><?= Yii::t('app', 'Dad\'s hair color:') ?></div>
...
<div class="<?php if (($result['viewResult'] <> 0) or Yii::$app->params['embed']): ?>result-div-on<?php else: ?>result-div-off<?php endif ?>">
    ...
    <div class="result-div-text">
            <span class="result-pre-text">
                <?php if ($result['childHairColor'] == 1): ?>
                    <?= Yii::t('app', 'With a high probability the child will have dark hair') ?><br>
                <?php endif; ?>
                <?php if ($result['childHairColor'] == 2): ?>
                    <?= Yii::t('app', 'With a high degree of probability the child will have dark or brown hair') ?><br>
                <?php endif; ?>
                <?php if ($result['childHairColor'] == 3): ?>
                    <?= Yii::t('app', 'With a high probability the child will be blond or with light brown hair') ?><br>
                <?php endif; ?>

                <?php if ($result['childHairColor'] == 5): ?>
                    <?= Yii::t('app', 'With a high probability the child will have red hair') ?><br>
                <?php endif; ?>
                <?php if ($result['childHairColor'] == 6): ?>
                    <?= Yii::t('app', 'With a high degree of probability the child will have light blond or red hair') ?><br>
                <?php endif; ?>

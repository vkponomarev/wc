...
<div class="<?php if (($result['viewResult'] <> 0) or Yii::$app->params['embed']): ?>result-div-on<?php else: ?>result-div-off<?php endif ?>">
    ...
    <div class="result-div-text">
            <span class="result-pre-text">
                     ...
                     <?= Yii::t('app', 'The average probability of a missed pregnancy:') ?> <?= $result['averageMissedMiscarriage'] ?> %<br><br>
 <?= Yii::t('app', 'The average probability of a missed pregnancy, depending on age:') ?> <?= $result['missedMiscarriage'] ?> %<br><br>

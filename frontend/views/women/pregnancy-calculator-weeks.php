...
<div class="<?php if (($result['calculation']['pregnancyCalculationDivShow']) or Yii::$app->params['embed']): ?>result-div-on<?php else: ?>result-div-off<?php endif ?>">
    ...
    <div class="result-div-text">
        ...
        <span class="result-main-text">
                    ...
                    <?php if ($result['calculation']['pregnancyCalculationException'] == 'echoPlanning'): ?>

                        <?= Yii::t('app', 'You are planning a pregnancy') ?>

                    <?php endif ?>

                    <?php if ($result['calculation']['pregnancyCalculationException'] == 'echoHaveBaby'): ?>

                        <?= Yii::t('app', 'You have already given birth to a baby') ?>

                    <?php endif ?>

                    <?php if ($result['calculation']['pregnancyCalculationException'] == 'echoWeeks'): ?>

                        <?= Yii::t('app', '{n,plural, one{# week} few{# weeks} other{# weeks}}', ['n' => $result['calculation']['pregnancyWeeks']]) ?>
                            ...
                            <?php if (isset($week[$i])): ?>
                                ...
                                <?php if (($week[$i]['pregnancyWeek'] & 1)
                                    ...
                                    <div class="col-xs-12 calendar-one-day pregnancy-day-odd"
                                         data-title="<?= $week[$i]['pregnancyWeek'] ?> <?= Yii::t('app', 'week of pregnancy') ?>">
                                <span>
                                     <?= $week[$i]['dayInMonth']; ?>

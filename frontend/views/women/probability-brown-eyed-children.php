...
<div class="<?php if (($result['viewResult'] <> 0) or Yii::$app->params['embed']): ?>result-div-on<?php else: ?>result-div-off<?php endif ?>">
    ...
    <div class="result-div-text">
            <span class="result-pre-text">
              ...
              <?= Yii::t('app', 'The probability of the birth of a brown-eyed child:') ?>
                <?= $result['childEyesColorBrown'] ?> %<br><br>
                ...
                <?php if ($result['childEyesColorGreen'] <> 0): ?>
                    <?= Yii::t('app', 'Green eyes') ?>
                    <?= $result['childEyesColorGreen'] ?> %<br>
                <?php endif; ?>

...
<div class="<?php if (($result['viewResult'] <> 0) or Yii::$app->params['embed']): ?>result-div-on<?php else: ?>result-div-off<?php endif ?>">
    ...
    <div class="result-div-text">
        <span class="result-pre-text">
            <?php if ($result['childSleep']): ?>
            <?= Yii::t('app', 'Daytime sleep:') ?>
                <?= Yii::t('app', '{n,plural, one{# hour} few{# hours} other{# hours}}', ['n' => $result['childSleep'][0][0]]) ?>,

            <?= Yii::t('app', 'number of daytime dreams:') ?> <?= $result['childSleep'][0][1] ?>
                    <br><br>

            <?= Yii::t('app', 'Night sleep:') ?>
            <?= Yii::t('app', '{n,plural, one{# hour} few{# hours} other{# hours}}', ['n' => $result['childSleep'][1]]) ?>


            <br><br>

            <?= Yii::t('app', 'Total Dream:') ?>
            <?= Yii::t('app', '{n,plural, one{# hour} few{# hours} other{# hours}}', ['n' => $result['childSleep'][2]]) ?>

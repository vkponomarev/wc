            ...
            <a href="/el/baby-weight-and-height-calculator/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">
                    ...
                    <p><img class="plates-img" src="/files/category-icons/35.png" alt="Υπολογιστής βάρους και ύψους μωρού" width="50"></p>

                    <p class="plates-title">Υπολογιστής βάρους και ύψους μωρού
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>
            ...
            <a href="/el/childrens-number-by-date-of-birth/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/75.png" alt="Υπολογιστής για τον αριθμό των παιδιών κατά την ημερομηνία γέννησης" width="50"></p>

                    <p class="plates-title">Υπολογιστής για τον αριθμό των παιδιών κατά την ημερομηνία γέννησης
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>

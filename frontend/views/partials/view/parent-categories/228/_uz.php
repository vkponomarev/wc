            ...
            <a href="/uz/child-sleep-9-year/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">
                    ...
                    <p><img class="plates-img" src="/files/category-icons/233.png" alt="9 yil ichida bola qancha uxlashi kerak" width="50"></p>

                    <p class="plates-title">9 yil ichida bola qancha uxlashi kerak
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>

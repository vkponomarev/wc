            ...
            <a href="/uz/ovulation-calendar/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/11.png" alt="Ovulyatsiya taqvimi" width="50"></p>

                    <p class="plates-title">Ovulyatsiya taqvimi
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>

            <a href="/uz/fertile-days-calendar/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/49.png" alt="Hosildorlik kunlarining taqvimi" width="50"></p>

                    <p class="plates-title">Hosildorlik kunlarining taqvimi
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>
            ...
            <a href="/uz/pregnancy-calendar/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/13.png" alt="Homiladorlik taqvimi" width="50"></p>

                    <p class="plates-title">Homiladorlik taqvimi
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>

            <a href="/uz/safe-days-calendar/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/33.png" alt="Xavfsiz kunlar taqvimi" width="50"></p>

                    <p class="plates-title">Xavfsiz kunlar taqvimi
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>

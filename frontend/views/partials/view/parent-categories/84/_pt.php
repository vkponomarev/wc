            ...
            <a href="/pt/probability-of-pregnancy-with-interrupted intercourse/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/77.png" alt="A probabilidade de gravidez com relação sexual interrompida" width="50"></p>

                    <p class="plates-title">A probabilidade de gravidez com relação sexual interrompida
                    </p>
            ...
            <a href="/pt/probability-of-pregnancy-after-menstruation/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/81.png" alt="A probabilidade de gravidez após a menstruação" width="50"></p>

                    <p class="plates-title">A probabilidade de gravidez após a menstruação
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>
            ...
            <a href="/pt/probability-of-ectopic-pregnancy/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/87.png" alt="A probabilidade de uma gravidez ectópica" width="50"></p>

                    <p class="plates-title">A probabilidade de uma gravidez ectópica
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>
            ...
            <a href="/pt/probability-of-in-vitro-fertilization/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/89.png" alt="A probabilidade de gravidez ecológica" width="50"></p>

                    <p class="plates-title">A probabilidade de gravidez ecológica
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>

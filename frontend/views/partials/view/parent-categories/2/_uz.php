            ...
            <a href="/uz/pregnancy-calculator-by-menstrual-period/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/5.png" alt="Hayz ko'rish muddati bo'yicha homiladorlik kalkulyatori" width="50"></p>

                    <p class="plates-title">Hayz ko'rish muddati bo'yicha homiladorlik kalkulyatori
                    </p>
            ...
            <a href="/uz/gestational-age-calculator/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/50.png" alt="Gestatsion muddat (homilaning yoshi) ning kalkulyatori" width="50"></p>

                    <p class="plates-title">Gestatsion muddat (homilaning yoshi) ning kalkulyatori
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>

            <a href="/uz/due-date-calculator/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/7.png" alt="Muddati kalkulyator" width="50"></p>

                    <p class="plates-title">Muddati kalkulyator
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>

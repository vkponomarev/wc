            ...
            <a href="/ro/probability-of-pregnancy-with-interrupted intercourse/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/77.png" alt="Probabilitatea sarcinii cu actul sexual întrerupt" width="50"></p>

                    <p class="plates-title">Probabilitatea sarcinii cu actul sexual întrerupt
                    </p>
            ...
            <a href="/ro/probability-of-ectopic-pregnancy/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/87.png" alt="Probabilitatea unei sarcini ectopice" width="50"></p>

                    <p class="plates-title">Probabilitatea unei sarcini ectopice
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>
            ...
            <a href="/ro/probability-of-pregnancy-day-before menstruation/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/79.png" alt="Probabilitatea sarcinii cu o zi înainte de menstruație" width="50"></p>

                    <p class="plates-title">Probabilitatea sarcinii cu o zi înainte de menstruație
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>
            ...
            <a href="/ro/probability-of-in-vitro-fertilization/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/89.png" alt="Probabilitatea sarcinii eco" width="50"></p>

                    <p class="plates-title">Probabilitatea sarcinii eco
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>

            ...
            <a href="/uz/child-weight-in-29-pregnancy-week/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">
                    ...
                    <p><img class="plates-img" src="/files/category-icons/155.png" alt="Homiladorlikning 29 xaftasida chaqaloqning vaznini hisoblash" width="50"></p>

                    <p class="plates-title">Homiladorlikning 29 xaftasida chaqaloqning vaznini hisoblash
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>

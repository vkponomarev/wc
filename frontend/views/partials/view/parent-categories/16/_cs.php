            ...
            <a href="/cs/menstrual-period-calendar/" class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-12 main-pages-extended">
                <div class="plates">

                    <p><img class="plates-img" src="/files/category-icons/12.png" alt="Menstruační kalendář" width="50"></p>

                    <p class="plates-title">Menstruační kalendář
                    </p>
                    <p class="plates-under-title"></p>
                </div>
            </a>
